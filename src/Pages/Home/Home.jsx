      ...
      <div className="pt-24">
        ...
        <div className="flex items-center justify-center flex-wrap mb-4">
          ...
          >
            ...
            <button className="h-10 w-28 border-2 border-white mt-3 rounded-md font-bold text-sm hover:bg-lime-600 transition delay-100 hover:border-none hover:text-white">
              Learn More
            </button>
          </div>
          <div
